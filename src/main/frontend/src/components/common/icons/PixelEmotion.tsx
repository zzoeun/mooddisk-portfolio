...
export const PixelEmotion: React.FC<PixelEmotionProps> = ({
  ...
  const getEmotionColors = (emotion: string) => {
    switch (emotion) {
      case 'happy':
        return { bg: 'bg-pink-400', border: 'border-pink-600' };
      case 'proud':
        return { bg: 'bg-yellow-400', border: 'border-yellow-600' };
      case 'peaceful':
        return { bg: 'bg-green-400', border: 'border-green-600' };
      case 'depressed':
        return { bg: 'bg-blue-500', border: 'border-blue-700' };
      case 'annoyed':
        return { bg: 'bg-gray-500', border: 'border-gray-700' };
      case 'furious':
        return { bg: 'bg-purple-600', border: 'border-purple-800' };
      default:
        return { bg: 'bg-gray-400', border: 'border-gray-600' };
    }
  };
